...
function searchForAnEmployee($districtName) {

	global $areas, $nearby, $workers; 


	// получаем ключ массива по значению
	$districtNumber = array_keys($areas, $districtName);

	// находим номера/ключи соседних районов
	$nearDistricts = $nearby[$districtNumber[0]];
	...
	print_r( array_flip($allDistricts)); 

}


searchForAnEmployee('Октябрьский');
